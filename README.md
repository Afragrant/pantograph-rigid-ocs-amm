...
| 指标   | 仿真 (N) | 实测 (N) | 差值 (N) | 相对误差 | 阈值      |
| ------ | -------- | -------- | -------- | -------- | --------- |
| 最大值 | 145.67   | 153.74   | -8.07    | 5.25%    | /         |
| 最小值 | 77.94    | 69.44    | +8.50    | 12.24%   | /         |
| 平均值 | 109.21   | 108.04   | +1.17    | 1.08%    | $\pm 2.5$ |
| 标准差 | 13.15    | 12.85    | +0.30    | 2.33%    | 20%       |

![](./docs/stats_compare.png)
